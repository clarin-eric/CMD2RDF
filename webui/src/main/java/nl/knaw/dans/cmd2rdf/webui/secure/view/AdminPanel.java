...
public class AdminPanel extends Panel {
	...
	public AdminPanel(String id, int selectedTabe) {
		...
		tabs.add(new AbstractTab(new Model<String>("Data Extraction"))
		{
			...
			public Panel getPanel(String panelId)
			{
				return new TabDataExtractionPanel(panelId, cmd2rdfConfFile);
			}
		});
		...
		tabs.add(new AbstractTab(new Model<String>("Data Cleaning"))
		{
			...
			public Panel getPanel(String panelId)
			{
				return new TabDataCleaningPanel(panelId, cmd2rdfConfFile);
			}
		});
		...
		tabs.add(new AbstractTab(new Model<String>("Execute TM Process"))
		{
			...
			public Panel getPanel(String panelId)
			{
				return new TabDataMiningPanel(panelId, cmd2rdfConfFile);
			}
		});
